...
"use strict";var e=t(require("@babel/runtime-corejs3/core-js-stable/instance/concat"));function t(e){return e&&e.__esModule?e:{default:e}}require("./scss/main.scss");var n=document.getElementById("video"),a=document.getElementById("play"),r=document.getElementById("stop"),i=document.getElementById("progress"),c=document.getElementById("timestamp");function u(){n.paused?n.play():n.pause()}function s(){n.paused?a.innerHTML='<i class="fa fa-play fa-2x"></i>':a.innerHTML='<i class="fa fa-pause fa-2x"></i>'}function d(){var t;i.value=n.currentTime/n.duration*100;var a=Math.floor(n.currentTime/60);a<10&&(a="0"+String(a));var r=Math.floor(n.currentTime%60);r<10&&(r="0"+String(r)),c.innerHTML=(0,e.default)(t="".concat(a,":")).call(t,r)}function l(){n.currentTime=+i.value*n.duration/100}function o(){n.currentTime=0,n.pause()}n.addEventListener("click",u),n.addEventListener("pause",s),n.addEventListener("play",s),n.addEventListener("timeupdate",d),a.addEventListener("click",u),r.addEventListener("click",o),i.addEventListener("change",l);
},{"@babel/runtime-corejs3/core-js-stable/instance/concat":"W5Mo","./scss/main.scss":"rbSf"}]},{},["uBxZ"], null)
//# sourceMappingURL=src.ae20409f.js.map